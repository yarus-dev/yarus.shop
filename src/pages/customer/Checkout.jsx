function CheckoutPage() {
  return (
    <>
      <main className="flex-1 max-w-prose mx-auto">
      ...
      <nav className="order-first sm:w-32">
        <ul className="m-0 list-none">
          <li className="mt-0 pt-2">
            <a href="#the-kings-plan" className="inline-block no-underline transition-colors hover:text-foreground text-muted-foreground">The King's Plan</a>
          </li>
        </ul>
      </nav>

      <aside className="sm:w-32 space-y-2 px-4">
